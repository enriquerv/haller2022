<div id="lms_widget_container">
  ...
  <div id="lms_widget_inner">
    <form name="form1" method="post" action="https://hallerpreescolar.neolms.com/log_in/submit" target="_blank">
      <label for="userid">ID Usuario</label>
      <input type="text" name="userid" id="userid" class="lms_widget_border">

      <label for="password">Contraseña</label>
      <a href="http://hallerpreescolar.neolms.com/log_in/forgot_password" target="_blank">(Olvide contraseña?)</a><br>
