...
<!-- saved from url=(0044)https://prepahaller.neolms.com/widget/source -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">
  ...
  <div id="lms_widget_inner">
    ...
    <form name="form1" method="post" action="https://prepahaller.neolms.com/log_in/submit" target="_blank">
      <label for="userid">ID Usuario</label>
      <input type="text" name="userid" id="userid" class="lms_widget_border">

      <label for="password">Contraseña</label>
      <a href="http://prepahaller.neolms.com/log_in/forgot_password" target="_blank">(Olvide contraseña?)</a><br>
