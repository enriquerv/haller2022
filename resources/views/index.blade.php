    ...
    <div id="multi-item-example" class="carousel slide carousel-multi-item container" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active">
          ...
          <div class="col-4" style="float:left">
           <div class="card mb-2 containerImg">
              <img src="{{ env('APP_URL') }}/assets/images2022/cards_niveles_maternal.png" width="100%" class="img-ofed" onclick="goTo('maternal')">
          ...
          <div class="col-4" style="float:left">
            <div class="card mb-2 containerImg">
              <img src="{{ env('APP_URL') }}/assets/images2022/cards_niveles_preescolar.png" width="100%" class="img-ofed" onclick="goTo('preescolar')">
          ...
          <div class="col-4" style="float:left">
            <div class="card mb-2 containerImg">
              <img src="{{ env('APP_URL') }}/assets/images2022/cards_niveles_english.png" width="100%" class="img-ofed" onclick="goTo('english')">
              <div class="centered dnone">VER MÁS</div>
            </div>
          </div>
        ...
        <div class="carousel-item">
          ...
          <div class="col-4" style="float:left">
            <div class="card mb-2 containerImg">
              <img src="{{ env('APP_URL') }}/assets/images2022/cards_niveles_primaria.png" width="100%" class="img-ofed" onclick="goTo('primaria')">
              <div class="centered dnone">VER MÁS</div>
            </div>
          </div>
          ...
          <div class="col-4" style="float:left">
            <div class="card mb-2 containerImg">
              <img src="{{ env('APP_URL') }}/assets/images2022/cards_niveles_secundaria.png" width="100%" class="img-ofed" onclick="goTo('secundaria')">
              <div class="centered dnone">VER MÁS</div>
            </div>
          </div>
          ...
          <div class="col-4" style="float:left">
            <div class="card mb-2 containerImg">
              <img src="{{ env('APP_URL') }}/assets/images2022/cards_niveles_prepa.png" width="100%" class="img-ofed" onclick="goTo('preparatoria')">
              <div class="centered dnone">VER MÁS</div>
            </div>
          </div>
